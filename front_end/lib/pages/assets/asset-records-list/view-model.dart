...
class AssetRecordListViewModel{
  DateTime currentDate = DateTime.now();
  List<Map<String, dynamic>> transactionsForDate(
      List<Map<String, dynamic>> transactions, String date) {
    return transactions
        .where((transaction) =>
    DateFormat.yMMMMd().format(transaction['waktu'] as DateTime) == date &&
        transaction['tipe'] == 'Expense')
        .toList();
  }
  Map<String, double> groupTransactionsByDate(
  ...
  List<Map<String, dynamic>> filterTransactionsByMonth(List<Map<String, dynamic>> transactions) {
